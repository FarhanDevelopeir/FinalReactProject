...
const Remove_user = ({ contact, onClose, data  }) => {
    ...
    return (
        <div className="absolute top-[50%] left-[50%] transform -translate-x-[50%] -translate-y-[50%]  box-border p-[20px] bg-slate-500  border border-black rounded-lg">
            <h2 className="font-sans font-semibold text-[22px] pb-[22px]">Are you sure you want to remove {data}?</h2>
