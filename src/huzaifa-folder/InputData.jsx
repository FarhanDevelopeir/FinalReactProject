          ...
          <div className="input-fields mx-auto w-[45%] h-[75vh] border-[3px] bg-slate-50 rounded-2xl border-black px-[80px] py-3">
            <div className="name_phone">
              <div className="name relative">
                <label htmlFor="Name" className="text-[35px] font-semibold font-sans">
                  Enter Name
                </label>
                <br />
                <input
              ...
              <div className="number relative">
                <label htmlFor="number" className="text-[35px] font-semibold font-sans">
                  Enter Phone Number
                </label>
                <br />
                <input
            ...
            <div className="email relative">
              <label htmlFor="email" className="text-[35px] font-semibold font-sans">
                Enter Email
              </label>
              <br />
              <input
                ...
                className="text-[25px] p-5 w-[400px] h-[40px] border-[2px] border-black rounded-lg"
              />
              <FontAwesomeIcon icon={faEnvelope} className="ml-4 text-[30px] absolute top-[60px] right-[0px]" />
              <br />
              <br />
            </div>
            <center>
              <button className="userAddBtn bg-slate-800 text-white text-[30px] font-sans font-semibold hover:bg-slate-950 w-[30%] h-[60px] my-2 border-[2px] border-black rounded-xl">
                Add User
              </button>
            </center>
          </div>
        ...
        <div className="back-button">
          <button>
            <Link to="/">
              <FontAwesomeIcon
                icon={faArrowLeft}
                className="ml-4 text-[30px] text-white bg-slate-700 px-5 py-3 hover:bg-slate-950 border-[2px] border-black rounded-lg absolute top-[120px] left-[20px]"
              />
            </Link>
          </button>
        </div>
